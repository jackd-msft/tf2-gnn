...
flags.DEFINE_integer('max_links', default=None, help='maximum number of nodes')
...
def main(_):
    ...
    dataset = builder.as_dataset(split=FLAGS.split,
                                 as_supervised=True).shuffle(20).repeat()
    dataset = block_diagonal_batch(dataset, max_nodes=max_nodes)
